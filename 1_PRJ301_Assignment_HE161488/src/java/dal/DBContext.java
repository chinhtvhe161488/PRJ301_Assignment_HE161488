...
public abstract class DBContext<T> {
    ...
    public DBContext() {
        try {
            ...
            String url = "jdbc:sqlserver://localhost\\SQLEXPRESS:1433;databaseName=PRJ_PhanQuyen";
//            String url = "jdbc:sqlserver://localhost\\SQLEXPRESS:1433;databaseName=PRJ301_att";
